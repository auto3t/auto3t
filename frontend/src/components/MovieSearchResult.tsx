...
const MovieSearchResult: React.FC<MovieSearchResultInterface> = ({ result }) => {
    ...
    <div className="movie-detail">
      <div className="movie-detail-header">
        ...
        <div className="movie-description">
          <h2>{result.name} ({new Date(result.release_date).getFullYear()})</h2>
          ...
          <div className="tag-group">
            {result.release_date && <span className="tag-item">Released: {result.release_date}</span>}
            {result.local_id ? (
