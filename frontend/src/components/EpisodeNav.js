  ...
  return (
    <div className='episode-nav-container'>
      <div className="episode-nav">
        {previousEpisode ? (
          <Link className='first-nav' title='previous episode' to={`/tv/episode/${previousEpisode.id}`}>
            <span>&#65308; </span>
        ...
        {nextEpisode ? (
          <Link className='next-nav' title='next episode' to={`/tv/episode/${nextEpisode.id}`}>
