...
| tv      | `/api/tv/show/<id>/actionlog_related/`     | show related actionlog |
| tv      | `/api/tv/season/`                          | season list |
| tv      | `/api/tv/season/<id>/`                     | season detail |
| tv      | `/api/tv/season/<id>/torrent/`             | season torrent |
| tv      | `/api/tv/season/<id>/actionlog/`           | season item actionlog |
| tv      | `/api/tv/season/<id>/actionlog_related/`   | season related actionlog |
